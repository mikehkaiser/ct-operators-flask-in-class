...
import secrets
# import login-manager from flask_login package
...
class DroneSchema(ma.Schema):
    class Meta:
        ...
        'dimensions', 'weight', 'cost_of_prod', 'series', 'user_token']
    
    
drone_schema = DroneSchema()
drones_schema = DroneSchema(many=True)
        #take Python class object like <Drone x1294898273948>
        #iterates through fields and adds them to a dictionary
