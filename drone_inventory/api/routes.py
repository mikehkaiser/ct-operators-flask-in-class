...
def create_drone(current_user_token):
    ...
    drone = Drone(name,description,price,camera_quality,flight_time,
    max_speed,dimensions,weight,cost_of_prod,series,user_token = user_token)
...
def update_drone(current_user_token, id):
    ...
    if drone:
        ...
        return jsonify({'Error': "That's not the drone you're looking for."})
